...
function promedioResultadosTest(resultadosTest) {
   ...
   // Tu código:
   return resultadosTest.reduce((prev, curr) => prev + curr, 0) / resultadosTest.length;
}
...
function multiplicarArgumentos() {
   ...
   else return [...arguments].reduce((prev, curr) => prev * curr, 1);
}
...
function mesesDelAño(array) {
   ...
   // Tu código:
   const newArray = array.filter(mes => mes === 'Marzo' || mes === 'Enero' || mes === 'Noviembre');
